...
Source0: http://download.gnome.org/sources/gnome-panel/3.16/%{name}-%{version}.tar.xz
...
BuildRequires: dconf-devel >= %{dconf_version}
...
Obsoletes: gnome-applets <= 1:3.8.1-1
...
# FIXME: GNOME-Flashback is not yet registered in list of DEs
